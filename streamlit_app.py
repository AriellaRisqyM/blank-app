...
def is_relevant_to_polri(text):
    ...
    keywords_polri = [
        "polri","polisi","kapolri","brimob","polda","polsek","polres",
        "satlantas","bhayangkara","penyidik","reskrim","sabhara","intelkam","propam"
    ]
    exclude_keywords = [
        "tni","tentara","prajurit","ad","au","al","kostrad","kopassus","kkb"
    ]
