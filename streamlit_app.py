# ==============================================================================
# Aplikasi Streamlit: Analisis Sentimen (Lexicon + ML) - Pemisahan Modeling
# ==============================================================================
...
#  remain EXACTLY the same as the previous version. Omitted for brevity,
#  but should be included in your final app.py)
...
# ==============================================================================
# Preprocessing & Labeling Functions
# ==============================================================================
def clean_text(text):
...
st.markdown("""
Aplikasi ini melakukan preprocessing, pelabelan sentimen berbasis **Lexicon**,
        ...
        try:
            ...
            if text_column:
                ...
                if st.session_state['labeled_df'] is not None:
                    df_hasil_label = st.session_state['labeled_df']
